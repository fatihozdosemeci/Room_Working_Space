...
import com.project.roomworkingspace.databinding.ItemsRowBinding
...
class ItemAdapter(private val items: ArrayList<EmployeeEntity>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(position % 2 == 0){
            holder.llMain.setBackgroundColor(ContextCompat.getColor(holder.itemView.context,R.color.purple_200))
        }else{
